...
export const api = {
  ...
  createMission:(scenarioId:string,name:string,aiMode:AIMode,projectContext:string,analysisPrompt:string,aiModel?:string)=>request<MissionDetail>("/missions",{method:"POST",body:JSON.stringify({scenario_id:scenarioId,name,ai_mode:aiMode,project_context:projectContext,analysis_prompt:analysisPrompt,ai_model:aiModel})}),
